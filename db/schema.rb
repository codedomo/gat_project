...
ActiveRecord::Schema.define(version: 2018_10_24_102921) do
  ...
  create_table "target_groups_countries", force: :cascade do |t|
    t.integer "target_group_id"
    t.integer "country_id"
    t.index ["country_id"], name: "index_target_groups_countries_on_country_id"
    t.index ["target_group_id"], name: "index_target_groups_countries_on_target_group_id"
  end
